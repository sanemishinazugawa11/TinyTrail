...
function Navbar() {
    return (
        <section className="navbar w-full border-b-[0.5px] border-blue-950/20 h-[10vh] flex px-10 py-2 justify-between items-center">
            ...
            <a href='https://github.com/sanemishinazugawa11/TinyTrail' target='_blank' className=" px-5 py-2 bg-blue-500 text-lg w-auto  font-semibold text-blue-50 font-brolimo tracking-wider rounded-md ">Github</a>
        </section>
    )
}
